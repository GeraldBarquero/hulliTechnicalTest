...
const bccr_service_1 = require("./bccr.service");
const invoice_1 = require("../entities/invoice");
const invoice_2 = require("../entities/invoice");
let BccrController = class BccrController {
...
], BccrController.prototype, "getValue", null);
__decorate([
    common_1.Post(),
    ...
    __metadata("design:returntype", void 0)
], BccrController.prototype, "createInvoice", null);
__decorate([
    common_1.Post(':id'),
    ...
    __metadata("design:returntype", void 0)
], BccrController.prototype, "payInvoice", null);
__decorate([
    common_1.Get(),
    ...
    __metadata("design:returntype", void 0)
], BccrController.prototype, "getAll", null);
__decorate([
    common_1.Delete(':id'),
    __param(0, common_1.Param('id')), __param(1, common_1.Res()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], BccrController.prototype, "deleteInvoice", null);
BccrController = __decorate([
    common_1.Controller('bccr'),
    __metadata("design:paramtypes", [typeof (_a = typeof bccr_service_1.BccrService !== "undefined" && bccr_service_1.BccrService) === "function" ? _a : Object])
], BccrController);
exports.BccrController = BccrController;
//# sourceMappingURL=bccr.controller.js.map